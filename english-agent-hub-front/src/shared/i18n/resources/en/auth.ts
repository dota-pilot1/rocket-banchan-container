export const auth = {
  ...
  signUpTitle: "Sign Up",
  signUpSubtitle: "Create your AEGIS account.",
  email: "Email",
  password: "Password",
  ...
  introTitle: "AEGIS admin console\nfor question operations",
  introSubtitle:
    "Manage exam extraction, question banks, exam assembly, and scoring workflows in one place.",
