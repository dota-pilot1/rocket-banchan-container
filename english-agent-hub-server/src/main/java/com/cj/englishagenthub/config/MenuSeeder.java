...
public class MenuSeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        List<MenuDef> defs = List.of(
                ...
                new MenuDef("QUESTION_EXTRACTOR",    "QUESTION_GEN", "문제 추출기", "nav.questionExtractor", "/question-generator/extractor", "FileSearch", RoleSeeder.ROLE_ADMIN,   2),
                ...
                new MenuDef("ADMIN",                 null,       "설정 관리",     "nav.admin",            null,                "Settings",        RoleSeeder.ROLE_ADMIN,   5),
